#include "cicada.h" //include of the top level of HLS model
#include "emulator.h" //include of emulator modeling
#include <any>
#include "ap_fixed.h"

using namespace CICADA_v2p1p1;

class caloADModel_v2p1p1 : public hls4mlEmulator::Model{
    private:
